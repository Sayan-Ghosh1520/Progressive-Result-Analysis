...
session_start();
include 'config.php';
$y_sem4 = (date("Y")-2)."_".(date("Y")+2);
$_SESSION['y_sem4']=$y_sem4;
include 'data4.php';
$table_sem = $y_sem4. "_4_sem";
$table_sub = $y_sem4. "_4_sub";
?>
...
<body style="font-size: 22px;">
  ...
  <h2>Department of Information Technology <br>
    Result Analysis Batch: <?php echo date("Y")-2; ?>-<?php echo date("Y")+2; ?>
   </h2>
</center>
   ...
   <div class="container">
     Semester: 4<br>
     Session: Jan <?php echo date("Y"); ?>-Jun <?php echo date("Y")."<br>"; ?>
