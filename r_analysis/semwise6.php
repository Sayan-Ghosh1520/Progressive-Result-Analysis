...
session_start();
include 'config.php';
$y_sem6 = (date("Y")-3)."_".(date("Y")+1);
$_SESSION['y_sem6']=$y_sem6;
include 'data6.php';
$table_sem = $y_sem6. "_6_sem";
$table_sub = $y_sem6. "_6_sub";
?>
...
<body style="font-size: 22px;">
  ...
  <h2>Department of Information Technology <br>
    Result Analysis Batch: <?php echo date("Y")-3; ?>-<?php echo date("Y")+1; ?>
   </h2>
</center>
